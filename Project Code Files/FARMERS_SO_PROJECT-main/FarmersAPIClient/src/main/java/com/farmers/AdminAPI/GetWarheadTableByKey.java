...
public class GetWarheadTableByKey {
...
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	/* public static void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/Warhead/GetWarheadTableByKey"; 
	  int tenantid = 2; 
	  String key = "Customer Consent Data";
	  String callid = "test123";
	  
	  GetWarheadTableByKey test = new GetWarheadTableByKey();
