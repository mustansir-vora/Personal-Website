...
public class OrderIDCard_FWS_NP_Post {
	...
	public JSONObject start(String url, String tid, String policynumber, String policysource, String lob, String policystate, String policysuffix, String deliverymethod, String effectivedate, String faxnumber, String firstname, String lastname, String middlename, String internalpolicynumber, String internalpolicyversion, String emailAddress, int conntimeout, int readtimeout, LoggerContext context, String region) {
		...
		try {
			...
			HashMap<String, String> headers = (HashMap<String, String>) getHeaders(Scope, tid, lob, policystate, policysource, logger, region);
	...
	private Map<String, String> getHeaders(String Scope, String tid, String lob, String policystate, String policysource, Logger logger,String region) {
	...
	public JSONObject formatErrorResponse(String error, int statusCode) {
	  ...
	  OrderIDCard_FWS_NP_Post test = new OrderIDCard_FWS_NP_Post();
	  resp = test.start(url, tid, policynumber, policysource, lob, policystate, policysuffix, deliverymethod, effectivedate, faxnumber, firstname, lastname, middlename, internalpolicynumber, internalpolicyversion, emailAddress, 10000, 10000, context,"uat");
	  } 
