...
public class GetStatePropertyTableByBusinessObjects {
	
	public JSONObject start(String url, String callid, int tenantid, String lob, String category, int conntimeout, int readtimeout, LoggerContext context) {
		Logger logger = context.getLogger(Constants.ADMIN_LOGGER_NAME);
		logger.info(callid+" : Params passed = "+url+" ,"+tenantid+", "+lob+", "+category+", "+conntimeout+", "+readtimeout);
	...
	/*  public static void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/StateProperty/GetStatePropertyTableByBusinessObjects";
	  int tenantid = 2; 
	  String key = "";
