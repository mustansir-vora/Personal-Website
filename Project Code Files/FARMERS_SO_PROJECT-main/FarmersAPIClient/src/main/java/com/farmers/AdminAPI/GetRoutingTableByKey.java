...
public class GetRoutingTableByKey {
...
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	/*  public static void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/Routing/GetRoutingTableByKey"; 
	  int tenantid = 2; 
	  String key = "Routing IVR Test Do not Delete";
	  String callid = "test123";
	  
	  GetRoutingTableByKey test = new GetRoutingTableByKey();
