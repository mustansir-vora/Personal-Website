...
public class FWSEPCPaymentus_NP_Get {
	...
	public JSONObject formatErrorResponse(String error, int statusCode) {
		...
		return jsonObject;
		  ...
		  String url = "https://api-ss.farmersinsurance.com/ivrms/v1/calls?phoneNumber=7574969953&operation=paymentstatus";
		  
		  FWSEPCPaymentus_NP_Get test = new FWSEPCPaymentus_NP_Get();
		  JSONObject resp = new JSONObject(); 
		  String tid = "Ciscotest"; 
		  resp = test.start(url, tid, 10000, 10000, context,"uat"); 
		  }
