...
public class OrderIDCard_FDS {
	
	public JSONObject start(String url, String tid, String policycontractnumber, String policysource, String deliverymethod, String size, String faxnumber, String emailaddress, int conntimeout, int readtimeout, LoggerContext context) {
	...
	public JSONObject formatErrorResponse(String error, int statusCode) {
	 ...
	 public static void main(String[] args) {
	  ...
	  OrderIDCard_FDS test = new OrderIDCard_FDS();
	  resp = test.start(url, tid, policynumber, policysource, deliverymethod, size, faxnumber, emailaddress, 10000, 10000, context); 
	  }
