...
public class AccountLinkAniLookup_NP_Post {
	...
	public JSONObject start(String url, String tid, String telephonenumber, int conntimeout, int readtimeout, LoggerContext context, String region) {
		...
		logger.info(tid+" : Parameters Passed from CVP : "+url+", "+tid+", "+telephonenumber+", "+conntimeout+", "+readtimeout+","+region);
	...
	public  String formRequestBody(String telephonenumber) {
	 ...
	 public static void main(String[] args) {
	  ...
	  AccountLinkAniLookup_NP_Post test = new AccountLinkAniLookup_NP_Post(); resp =
	  test.start(url, tid, telephonenumber, 10000, 10000, context,region);
