...
public class GetAniGroupHandlingTableByBusinessObjects {
...
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	/*  public static void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/AniGroupHandling/GetAniGroupHandlingTableByBusinessObjects";
	  int tenantid = 2; 
	  String key = "";
	  ...
	  GetAniGroupHandlingTableByBusinessObjects test = new GetAniGroupHandlingTableByBusinessObjects();
