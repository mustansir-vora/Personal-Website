...
public class Ciscosrmcti_NP_Post {
...
String requestBody = formRequestBody(tid, callerani, destinationapp, tollfreenumber, callerinput, poptype, calledinto, calledintime, tollfreedescription, callertype, language, an1, upn1, transferreason, intent, brand, validpolicynumber, callerrisklevel
	...
	private  Map<String, String> getHeaders(String Scope, String tid, Logger logger, String region) {
		...
		try {
			...
			headers.put("frms_target", prop.getProperty("Farmers.Host.CISCOSRMCTI.frms_target"));
...
public  String formRequestBody(String ivrcallid, String callerani, String destinationapp, String tollfreenumber, String callerinput, String poptype, String calledinto, String calledintime, String tollfreedescription, String callertype, String language, String an1, String upn1, String transferreason, String intent , String brand , boolean validpolicynumber,
		...
		try {
			...
			Customer.put("CCAI_Customer_FirstName", "CCAI_Customer_FirstName");

	        JSONObject Agent = new JSONObject();
	        
	        Agent.put("CCAI_Agent_FirstName", "CCAI_Agent_FirstName");
	        ...
	        outerObject.put("IVRInfo", IVRInfo); */
			        ...
			        // Create main object IVRInfo
			        JSONObject IVRInfo = new JSONObject();
	 ...
	 public static void main(String[] args) {
	  ...
	  String url = "https://api-np-ss.farmersinsurance.com/ivrms/v1/ivrrecords/CiscoTest";
	  JSONObject resp = null; 
	  String tid = "CiscoTest";
	  
	  String brand = "SO";
	  String TollFreeNumber = "8009097777";
	  String poptype = "01";
	  String CallerType = "02";
	  String ANI = "7574969953";
	  ...
	  String Intent = "FarmersPL_AutoPolicyChgsMenu:SomethingElse";
	  String TransferReason = "Policy Discounts";
	  String TollFreeDescription = "FASO Entry (Cisco)";
	  ...
	  Ciscosrmcti_NP_Post test = new Ciscosrmcti_NP_Post();
	  resp = test.start(url, tid, ANI, DestinationApp, TollFreeNumber, CallerInput, poptype, CalledInto, CalledInTime, TollFreeDescription, CallerType, Language, AN1, UPN1, TransferReason, Intent, brand ,ValidPolicyNumber, callerrisklevel, 10000, 10000, 
			  context,
			  CCAI_Agent_FirstName,
			  CCAI_Agent_LastName,
			  CCAI_Agent_State,
