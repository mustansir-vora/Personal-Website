...
public class BillPresentmentretrieveBillingSummary_Post {
	
//private Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	
public JSONObject start(String url, String tid, String applicationtype, String systemname, boolean loopback, String policynumber, String productgroupname, int conntimeout, int readtimeout, LoggerContext context) {
	...
	private  Map<String, String> getHeaders(String Scope, String tid, Logger logger) {
		...
		try {
	        ...
	        logger.info(tid+" : Host Encrypted client id : "+client_id+", Host Encrypted client secret : "+client_secret);
	...
	public  String formRequestBody(String applicationtype, String systemname, boolean loopback, String policynumber, String productgroupname) {
	  ...
	  String applicationtype = "VRS-101";
	  String systemname = "VRS";
	  String policynumber = "200341263";
	  boolean loopback = false;
	  String productgroupname = "FAB";
	  
	  BillPresentmentretrieveBillingSummary_Post test = new BillPresentmentretrieveBillingSummary_Post(); 
	  resp = test.start(url, tid, applicationtype, systemname, loopback, policynumber, productgroupname, 5000, 5000, context);
