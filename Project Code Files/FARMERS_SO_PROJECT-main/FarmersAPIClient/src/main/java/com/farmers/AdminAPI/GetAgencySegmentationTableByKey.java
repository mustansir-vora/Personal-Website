...
public class GetAgencySegmentationTableByKey {
	...
	/*  public void main(String args[]) throws InterruptedException {
	   ...
	   //String url = "https://EC2AMAZ-ALDVADR/fiivrapi/api/AgencySegmentation/GetAgencySegmentationTableByKey";
	   String url = "https://104.156.46.196/IVRAPI/api/AgencySegmentation/GetAgencySegmentationTableByKey";
	   int tenantid = 2; 
	   String key = "AgencySegmentation DoNotDelete";
