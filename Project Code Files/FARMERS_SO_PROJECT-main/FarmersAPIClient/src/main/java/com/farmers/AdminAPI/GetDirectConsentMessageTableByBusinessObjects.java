...
public class GetDirectConsentMessageTableByBusinessObjects {
	...
	/*  public static void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/DirectConsentMessage/GetDirectConsentMessageTableByBusinessObjects";
	  int tenantid = 2; 
	  String key = "";
