...
public class EPCPaymentusGroup_NP_Post {
	
	//private Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	
	public  JSONObject start(String url, String tid, String operation, String id, String authtoken, String languagepreference, String brandcode, String firstname, String lastname, long phonenumber, String email, String addressline1, String state, String zipcode, String city, String country, int conntimeout, int readtimeout, LoggerContext context, String region) {
	...
	public  JSONObject formatErrorResponse(String error, int statusCode) {
	  ...
	  EPCPaymentusGroup_NP_Post test = new EPCPaymentusGroup_NP_Post();
	  JSONObject resp = null; 
	  resp = test.start(url, tid, operation, id, authtoken, languagepreference, brandcode, firstname, lastname, phonenumber, email, addressline1, state, zipcode, city, country, 10000, 10000, context,"uat");
	  }
