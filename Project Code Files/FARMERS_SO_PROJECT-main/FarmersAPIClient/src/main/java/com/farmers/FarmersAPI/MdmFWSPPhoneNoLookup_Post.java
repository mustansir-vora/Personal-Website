...
public class MdmFWSPPhoneNoLookup_Post {
	
	//private final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);

	public JSONObject start(String url, String tid, String telephonenumber, String excludedSource, int conntimeout, int readtimeout, LoggerContext context) {
	...
	public String formRequestBody(String telephonenumber,String excludedSource) {
	  ...
	  String telephoneNumber = "842103796";
	  String excludedSource="Life";
	  JSONObject resp = null;
	  
	  MdmFWSPPhoneNoLookup_Post test = new MdmFWSPPhoneNoLookup_Post();
	  //resp = test.start(url, tid, telephoneNumber, excludedSource, 18000, 18000, context);
	  
	  try {
	  
		  Encrypt_Decrypt ED= new Encrypt_Decrypt();
		  //ED.encrypt("11D6e1F7bbaA40c4A0F2c467aF11522C");
		  System.out.println(ED.encrypt("76b8b4f63b7e4a04abd017a8aac3f71c"));
	  }
