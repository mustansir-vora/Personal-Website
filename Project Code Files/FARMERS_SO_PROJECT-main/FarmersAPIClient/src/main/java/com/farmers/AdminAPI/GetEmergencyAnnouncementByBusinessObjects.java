...
public class GetEmergencyAnnouncementByBusinessObjects {
...
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	private Map<String, String> getHeaders(Logger logger, String callid) {
	 ...
	 /* public static void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/EmergencyAnnouncement/GetEmergencyAnnouncementByBusinessObjects";
	  int tenantid = 2; 
	  ...
	  GetEmergencyAnnouncementByBusinessObjects objGetEmergencyAnnouncementByBusinessObjects = new GetEmergencyAnnouncementByBusinessObjects();
	  JSONObject response = objGetEmergencyAnnouncementByBusinessObjects.start(url, callid, tenantid, dnis, dnisgroup, lob, category, 10000, 10000, context);
