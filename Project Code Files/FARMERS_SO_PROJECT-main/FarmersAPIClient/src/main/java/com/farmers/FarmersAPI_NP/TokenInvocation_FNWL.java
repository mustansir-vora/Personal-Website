...
public class TokenInvocation_FNWL {
	...
	public String getToken(String Scope, Logger logger, String tid) {
		...
		try {
			...
			String Base64 = prop.getProperty("FARMERS.FNWL.NonProd.OAuthToken");
			...
			String frms_region = prop.getProperty("FARMERS.FNWL.NonProd.OAuth.frms_region_QA");
