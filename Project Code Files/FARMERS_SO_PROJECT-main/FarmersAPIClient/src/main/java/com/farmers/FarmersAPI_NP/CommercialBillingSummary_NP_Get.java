...
public class CommercialBillingSummary_NP_Get {

	//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
		
		public JSONObject start(String url, String tid, int conntimeout, int readtimeout, LoggerContext context, String region) {
		...
		private Map<String, String> getHeaders(String Scope, String tid, Logger logger, String region) {
			...
			try {
				...
				headers.put("frms_transactiontimestamp", "1.2");
		...
		public static JSONObject formatErrorResponse(String error, int statusCode) {
		...
		/*  public static void main(String[] args) {
		  ...
		  url ="https://api-ss.farmersinsurance.com/bibillingms/v1/customers/A09600185/billingSummary?idType=PolicyNumber";
		  
		  //Search By Account Number 
		  //url ="https://api-ss.farmersinsurance.com/bibillingms/v1/customers/F008500818/billingSummary?idType=AccountNumber";
		  JSONObject resp = null; 
		  String tid = "Ciscotest";
		  CommercialBillingSummary_Get test = new CommercialBillingSummary_Get();
