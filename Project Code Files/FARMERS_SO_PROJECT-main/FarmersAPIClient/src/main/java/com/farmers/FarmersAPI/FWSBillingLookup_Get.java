...
public class FWSBillingLookup_Get {
	
//private Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	
	public  JSONObject start(String url, String tid, String policysource, String policystate, String lob, int conntimeout, int readtimeout, LoggerContext context) {
		...
		try {
			...
			HashMap<String, String> headers = (HashMap<String, String>) getHeaders(Scope, tid, policysource, policystate, lob, logger);
	...
	private  Map<String, String> getHeaders(String Scope, String tid, String policysource, String policystate, String lob, Logger logger) {
	...
	public  JSONObject formatErrorResponse(String error, int statusCode) {
	  ...
	  String lob = "A";
	  FWSBillingLookup_Get test = new FWSBillingLookup_Get();
	  JSONObject resp = test.start(url, tid, policysource, policystate, lob, 10000, 10000, context);
