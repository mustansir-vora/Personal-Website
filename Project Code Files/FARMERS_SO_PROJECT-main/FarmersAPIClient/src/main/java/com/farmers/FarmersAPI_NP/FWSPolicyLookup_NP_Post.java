...
public class FWSPolicyLookup_NP_Post {
	
	//private final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);

	public JSONObject start(String url, String tid, String policycontractnumber, String billingaccountnumber, String telephonenumber, int conntimeout, int readtimeout, LoggerContext context, String region) {
	...
	public String formRequestBody(String policycontractnumber, String billingaccountnumber, String telephonenumber) {
		...
		try {
			...
			if (policycontractnumber != null && !policycontractnumber.equalsIgnoreCase("") && billingaccountnumber == null && telephonenumber == null) {
				Criteria.put("policyContractNumbers", policycontractnumber);
				Criteria.put("billingAccountNumber", billingaccountnumber);
				...
				Criteria.put("policyContractNumbers", "default");
				Criteria.put("billingAccountNumber", "default");
	  ...
	  String policyContractNumbers = "842103796";
	  JSONObject resp = null;
	  
	  FWSPolicyLookup_NP_Post test = new FWSPolicyLookup_NP_Post();
	  resp = test.start(url, tid, policyContractNumbers, null, null, 10000, 10000, context,"uat");
	  }
