...
public class GetAniGroupHandlingTableByKey {
...
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	private Map<String, String> getHeaders(Logger logger, String callid) {
	 ...
	 /* public static void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/AniGroupHandling/GetAniGroupHandlingTableByKey";
	  int tenantid = 2; 
	  String key = "Ani Group Handling do not delete";
	  String callid = "test123";
	  
	  GetAniGroupHandlingTableByKey test = new GetAniGroupHandlingTableByKey();
