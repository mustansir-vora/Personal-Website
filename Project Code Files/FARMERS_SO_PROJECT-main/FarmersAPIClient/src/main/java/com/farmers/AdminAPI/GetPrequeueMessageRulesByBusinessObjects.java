...
public class GetPrequeueMessageRulesByBusinessObjects {
...
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	/* public static void main(String args[]) {
	 ...
	 context.setConfigLocation(file.toURI());
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/PrequeueMessageRules/GetPrequeueMessageRulesByBusinessObjects";
	  int tenantid = 2; 
	  ...
	  GetPrequeueMessageRulesByBusinessObjects objGetPrequeueMessageRulesByBusinessObjects = new GetPrequeueMessageRulesByBusinessObjects();
	  JSONObject response = objGetPrequeueMessageRulesByBusinessObjects.start(url, callid, tenantid, dnis, dnisgroup, lob, category, 10000, 10000, context);
