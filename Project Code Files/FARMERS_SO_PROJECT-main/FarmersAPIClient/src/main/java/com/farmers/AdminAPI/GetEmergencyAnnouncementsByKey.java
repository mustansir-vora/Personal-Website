...
public class GetEmergencyAnnouncementsByKey {

//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	
	public JSONObject start(String url, String callid, int tenantid, String key, int conntimeout, int readtimeout, LoggerContext context) {
	...
	private Map<String, String> getHeaders(Logger logger, String callid) {
	 ...
	 /* public static void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/EmergencyAnnouncement/GetEmergencyAnnouncementsByKey";
	  int tenantid = 2; 
	  String key = "Emergency donotdelete";
	  String callid = "test123";

	  GetEmergencyAnnouncementsByKey objGetEmergencyAnnouncementsByKey = new GetEmergencyAnnouncementsByKey();
	  JSONObject response = objGetEmergencyAnnouncementsByKey.start(url, callid, tenantid, key, 10000, 10000, context);
