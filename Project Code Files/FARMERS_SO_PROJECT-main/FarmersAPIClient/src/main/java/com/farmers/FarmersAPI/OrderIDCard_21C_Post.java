...
public class OrderIDCard_21C_Post {
	
	public JSONObject start(String url, String tid, String policycontractnumber, String mastercompanycode, String deliverymethod, String size, String faxnumber, String emailaddress, int conntimeout, int readtimeout, LoggerContext context) {
	...
	public JSONObject formatErrorResponse(String error, int statusCode) {
	 ...
	 public static void main(String[] args) {
	  ...
	  String policynumber = "T00100020811";
	  String mastercompanycode = "91";
	  String deliverymethod = "Email"; 
	  String size = "LS";
	  String faxnumber = null; // Can be null when delivery method Mail or Email
	  String emailaddress = "mustansir.saifuddin@servion.com"; // Can be null when delivery method Mail or Fax
	  
	  OrderIDCard_21C_Post test = new OrderIDCard_21C_Post();
	  resp = test.start(url, tid, policynumber, mastercompanycode, deliverymethod, size, faxnumber, emailaddress, 10000, 10000, context); 
	  }
}
