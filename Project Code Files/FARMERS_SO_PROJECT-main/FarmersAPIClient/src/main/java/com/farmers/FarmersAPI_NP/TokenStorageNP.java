...
public class TokenStorageNP {
	
	//private Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);

	private static TokenStorageNP tokenStorage = null;
	private static HashMap<String, TokenBean> tokens = null;
	private TokenStorageNP () {
		
	}
	
	public static TokenStorageNP getInstance() {
		if(tokenStorage == null) {
			tokenStorage = new TokenStorageNP();
