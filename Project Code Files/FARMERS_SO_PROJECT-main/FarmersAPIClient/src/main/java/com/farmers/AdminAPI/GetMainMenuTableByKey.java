...
public class GetMainMenuTableByKey {
...
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	/*  public static void main(String args[]) {
	  ...
	  String url ="https://104.156.46.196/IVRAPI/api/MainMenu/GetMainMenuTableByKey"; 
	  int tenantid = 2; 
	  String key = "Foremost Sales Express";
	  String callid = "test123";
	  
	  GetMainMenuTableByKey test = new GetMainMenuTableByKey();
