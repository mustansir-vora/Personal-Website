...
public class GetCallerDetailsByAni {
	
	public JSONObject start(String url, String callid, int tenantid, String ani, int conntimeout, int readtimeout, LoggerContext context) {
		Logger logger = context.getLogger(Constants.ADMIN_LOGGER_NAME);
		logger.info(callid + " : Params passed = "+url+" ,"+tenantid+", "+ani+", "+conntimeout+", "+readtimeout);
  ...
  /*	public static void main(String[] args) {
		LoggerContext context = (org.apache.logging.log4j.core.LoggerContext) LogManager.getContext(false);;
	      ...
	      String url = "https://104.156.46.196/IVRAPI/api/CallerDetail/GetCallerDetailsByAni";
		  int tenantid = 2; 
		  String ani = "Ani new";
		  String callid = "test123";
		  
		  GetCallerDetailsByAni objGetCallerDetailsByAni = new GetCallerDetailsByAni();
		  JSONObject response = objGetCallerDetailsByAni.start(url, callid, tenantid, ani, 10000, 10000, context);
	}  */
