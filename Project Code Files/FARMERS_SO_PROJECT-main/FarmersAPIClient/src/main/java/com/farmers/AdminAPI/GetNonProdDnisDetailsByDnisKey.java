...
public class GetNonProdDnisDetailsByDnisKey {
	...
	/*  public static void main(String args[]) {
	  ...
	  String url = "https://EC2AMAZ-ALDVADR/fiivrapi/api/Dnis/GetBusinessObjectsByDnisKey";
	  int tenantid = 2; 
	  String key = "123456789";
	  
	  GetBusinessObjectsByDnisKey objGetBusinessObjectsByDnisKey = new GetBusinessObjectsByDnisKey(); 
	  JSONObject response = objGetBusinessObjectsByDnisKey.start(url, "Test123", tenantid, key, 10000, 10000, context);
