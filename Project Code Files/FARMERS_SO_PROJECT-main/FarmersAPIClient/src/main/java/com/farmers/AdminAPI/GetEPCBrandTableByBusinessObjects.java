...
public class GetEPCBrandTableByBusinessObjects {
	
public JSONObject start(String url, String callid, int tenantid, String dnis, int conntimeout, int readtimeout, LoggerContext context) {
		
		Logger logger = context.getLogger(Constants.ADMIN_LOGGER_NAME);
		logger.info(callid+" : Params passed = "+url+" ,"+tenantid+", "+dnis+", "+conntimeout+", "+readtimeout);
	...
	/*  public static void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/EPCBrand/GetEPCBrandTableByBusinessObjects"; 
	  int tenantid = 2; 
	  String callid = "test123";
	  String dnis = "99510204120";
