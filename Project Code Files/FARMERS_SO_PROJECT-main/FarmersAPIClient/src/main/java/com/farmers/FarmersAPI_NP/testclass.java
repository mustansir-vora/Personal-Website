...
public class testclass {
	...
	public void runtestafni() {
		...
		try {
			...
			JSONObject resp = test.start(url, tid, callerani, policynumber, accountnumber, originaldnis, originaldnisdescription, zipcode, quotenumber, state, 10000, 10000, context,"uat");
