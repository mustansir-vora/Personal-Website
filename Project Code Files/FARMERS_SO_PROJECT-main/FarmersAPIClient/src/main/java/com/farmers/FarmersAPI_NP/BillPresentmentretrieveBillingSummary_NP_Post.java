...
public class BillPresentmentretrieveBillingSummary_NP_Post {
...
public JSONObject start(String url, String tid, String applicationtype, String systemname, boolean loopback, String policynumber, String productgroupname, int conntimeout, int readtimeout, LoggerContext context, String region) {
		...
		logger.info(tid+" : Parameters Passed from CVP : "+url+", "+tid+", "+applicationtype+", "+systemname+", "+loopback+", "+policynumber+", "+productgroupname+", "+conntimeout+", "+readtimeout+","+region);
	...
	public  String formRequestBody(String applicationtype, String systemname, boolean loopback, String policynumber, String productgroupname) {
	  ...
	  String region ="uat";
	  BillPresentmentretrieveBillingSummary_NP_Post test = new BillPresentmentretrieveBillingSummary_NP_Post(); 
	  resp = test.start(url, tid, applicationtype, systemname, loopback, policynumber, productgroupname, 5000, 5000, context, region);
