...
public class AgentInfoRetrieveByAOR_Post {
	
	public JSONObject start(String url, String tid, String aorid, String businessunit, String userid, String systemname, String terminatedagentindicator, int conntimeout, int readtimeout, LoggerContext context) {

		Logger logger = context.getLogger(Constants.FARMERS_LOGGER_NAME);
		logger.info(tid+" : Parameters Passed from CVP : "+url+", "+tid+", "+aorid+", "+businessunit+", "+userid+", "+systemname+", "+terminatedagentindicator+", "+conntimeout+", "+readtimeout);
