...
public class GetMainTableByKey {
...
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	/*  public static void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/Main/GetMainTableByKey";
	  int tenantid = 2; 
	  String key = "Friends and Family Homeowners (Cisco)";
	  String callid = "test123";
	  GetMainTableByKey test = new GetMainTableByKey();
