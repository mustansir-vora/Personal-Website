...
public class Commercialsrmcti_NP_Post {
	
	//private Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	
public  JSONObject start(String url, String tid, String callerani, String destinationapp, String tollfreenumber,
		String callerinput, String poptype, String calledinto, String calledintime, String tollfreedescription, 
		String callertype, String language, String an1, String upn1, String transferreason, String intent , String brand , 
		boolean validpolicynumber, String callerrisklevel, int conntimeout, int readtimeout, LoggerContext context,
		...
		String CCAI_Customer_ECN, String region) {
	...
	private  Map<String, String> getHeaders(String Scope, String tid, Logger logger, String region) {
		...
		try {
			...
			headers.put("frms_target", prop.getProperty("Farmers.Host.COMMERCIALSRMCTI.frms_target"));
	...
	public  String formRequestBody(String ivrcallid, String callerani, String destinationapp, String tollfreenumber, String callerinput, String poptype, String calledinto, String calledintime, String tollfreedescription, String callertype, String language, String an1, String upn1, String transferreason, String intent , String brand , boolean validpolicynumber, String callerrisklevel,
	 ...
	 public static void main(String[] args) {
	  ...
	  String brand = "Foremost";
	  String TollFreeNumber = "8888401248";
	  String poptype = "01";
	  String CallerType = "02";
	  String ANI = "4805802363";
	  String DestinationApp = "SRM";
	  boolean ValidPolicyNumber = false;
	  String UPN1 = "40223";
	  String AN1 = "162561";
	  String CallerInput = "123456789";
	  String CalledInto = "9876543210";
	  String CalledInTime = "";
	  String Intent = "pc_policy-relate_household";
	  ...
	  Commercialsrmcti_NP_Post test = new Commercialsrmcti_NP_Post();
