...
public class PointPolicyInquiry_NP_Get {
	...
	public JSONObject formatErrorResponse(String error, int statusCode) {
	  ...
	  String url = "https://api-ss.farmersinsurance.com/plcyms/v3/policies/21365978"; 
	  JSONObject resp = null; 
	  String tid = "CiscoTest"; 
	  PointPolicyInquiry_NP_Get test = new PointPolicyInquiry_NP_Get();
