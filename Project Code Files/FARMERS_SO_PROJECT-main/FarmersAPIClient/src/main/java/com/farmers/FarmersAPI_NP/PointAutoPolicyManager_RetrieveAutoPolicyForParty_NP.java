...
public class PointAutoPolicyManager_RetrieveAutoPolicyForParty_NP {
	
	//private Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);

	public JSONObject start(String url, String tid, String userid, String systemname, String firstname, String lastname,String telephonenumber, int conntimeout, int readtimeout, LoggerContext context, String region) {
	...
	public String formRequestBody(String tid, String userid, String systemname, String firstname, String lastname,String telephonenumber) {
	  ...
	  PointAutoPolicyManager_RetrieveAutoPolicyForParty_NP test = new PointAutoPolicyManager_RetrieveAutoPolicyForParty_NP();
	  resp = test.start(url, tid, userid, systemname, firstname, lastname, telephonenumber, 10000, 10000, context,"uat");
	  }
