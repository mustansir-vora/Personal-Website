...
public class ForemostPolicyInquiry_NP_Post {
	
	//private  final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	
	public  JSONObject start(String url, String tid, String policynumber, String systemdate, String policysource, int conntimeout, int readtimeout, LoggerContext context, String region) {
	...
	public  JSONObject formatErrorResponse(String error, int statusCode) {
	    ...
	    public static void main(String[] args) { 
		  ...
		  ForemostPolicyInquiry_NP_Post test = new ForemostPolicyInquiry_NP_Post();
		  resp = test.start(url, tid, "0080881219", "04/17/2024", "Foremost", 10000, 10000, context,"uat"); 
	  } 
