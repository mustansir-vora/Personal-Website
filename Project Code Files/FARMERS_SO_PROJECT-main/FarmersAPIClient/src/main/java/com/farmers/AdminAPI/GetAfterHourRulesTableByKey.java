...
public class GetAfterHourRulesTableByKey {
	...
	/*  public static void main(String args[]) throws InterruptedException {
	      ...
	      String url = "https://104.156.46.196/IVRAPI/api/AfterHourRules/GetAfterHourRulesTableByKey";
	  int tenantid = 2;
	  String key = "After Hour Rule 7";
	  String callid = "Test123";
	  JSONObject response = new JSONObject();
	  GetAfterHourRulesTableByKey objGetAfterHourRulesTableByKey = new GetAfterHourRulesTableByKey(); 
	  response = objGetAfterHourRulesTableByKey.start(url, callid, tenantid, key, 10000, 10000, context);
