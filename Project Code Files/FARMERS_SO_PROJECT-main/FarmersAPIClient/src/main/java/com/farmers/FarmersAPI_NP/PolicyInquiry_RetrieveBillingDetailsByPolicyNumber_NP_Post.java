...
public class PolicyInquiry_RetrieveBillingDetailsByPolicyNumber_NP_Post {
	
	//private Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);

	public JSONObject start(String url, String tid, String functionname, String agreementmode,String agreementsymbol, String policynumber, String postalcode, int conntimeout, int readtimeout, LoggerContext context, String region) {
	...
	public String formRequestBody(String functionname, String policynumber, String agreementmode,String agreementsymbol, String postalcode) {
	  ...
	  PolicyInquiry_RetrieveBillingDetailsByPolicyNumber_NP_Post test = new PolicyInquiry_RetrieveBillingDetailsByPolicyNumber_NP_Post();
	  
	  resp = test.start(url, tid, functionname, agreementmode, agreementsymbol, policynumber, postalcode, 10000, 10000, context,"uat"); 
	  }
