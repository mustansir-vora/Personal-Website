...
public class GetEmployeeServiceLineDetails {
	
	public JSONObject start(String url, String callid, String loginid, int conntimeout, int readtimeout, LoggerContext context) {
	...
	private Map<String, String> getHeaders(Logger logger, String callid) {
  	...
  	public static void main(String[] args) {
		  ...
		  String url = "https://104.156.46.196/IVRAPI_DEV/api/EmployeeServiceLine/GetEmployeeServiceLineDetails"; 
		  String callid = "test123";
		  String loginid = "122100126";
		  
		  GetEmployeeServiceLineDetails test = new GetEmployeeServiceLineDetails();
		  JSONObject response = test.start(url, callid, loginid, 10000, 10000, context);
	}  
