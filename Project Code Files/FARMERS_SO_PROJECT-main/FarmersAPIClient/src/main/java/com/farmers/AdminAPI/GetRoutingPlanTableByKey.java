...
public class GetRoutingPlanTableByKey {
...
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	private static Map<String, String> getHeaders(Logger logger, String callid) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/RoutingPlan/GetRoutingPlanTableByKey";
	  int tenantid = 2; 
	  String key = "RoutingPlan donotdelete";
	  String callid = "test123";
	  
	  GetRoutingPlanTableByKey test = new GetRoutingPlanTableByKey();
	  JSONObject response = test.start(url, callid, tenantid, key, 10000, 10000, context);
