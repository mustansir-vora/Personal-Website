...
public class GetWarheadBackendTableByKey {
...
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	public JSONObject start(String url, String callid, int tenantid, String key, int conntimeout, int readtimeout, LoggerContext context) {
		...
		try {
			...
			logger.info("Final Response = "+resp);
		}
		catch (Exception e) {
	...
	/* public static void main(String args[]) {
	 ...
	 String url = "https://104.156.46.196/IVRAPI/api/WarheadBackend/GetWarheadBackendTableByKey";
	 int tenantid = 2; 
	 String key = "FWS One Time Payment Web Service";
	 String callid = "test123";
	 
	 GetWarheadBackendTableByKey test = new GetWarheadBackendTableByKey();
