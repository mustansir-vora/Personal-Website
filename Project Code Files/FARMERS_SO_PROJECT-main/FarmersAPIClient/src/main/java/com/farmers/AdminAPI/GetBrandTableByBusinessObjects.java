...
public class GetBrandTableByBusinessObjects {
	...
	/*  public static void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/Brand/GetBrandTableByBusinessObjects";
	  int tenantid = 2; 
	  String callid = "test123";
	  String dnis = "99510610389"; 
	  String dnisgroup = "test"; 
	  String lob = "test"; 
