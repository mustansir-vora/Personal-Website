...
public class GetIVRPropertyByKey {
...
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	/*  public void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/IVRProperty/GetIVRPropertyTableByKey";
	  int tenantid = 2; 
	  String callid = "test123";
	  String key = "IVRproperty do not delete";
	  
	  GetIVRPropertyByKey objGetIVRPropertyByKey = new GetIVRPropertyByKey();
	  JSONObject response = objGetIVRPropertyByKey.start(url, callid, tenantid, key, 10000, 10000, context);
