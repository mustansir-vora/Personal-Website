...
public class FWSsrmcti_NP_Post {
	...
	private  Map<String, String> getHeaders(String Scope, String tid, Logger logger, String region) {
		...
		try {
			...
			headers.put("frms_target", prop.getProperty("Farmers.Host.FWSSRMCTI.frms_target"));
	...
	public  String formRequestBody(String ivrcallid, String callerani, String destinationapp, String tollfreenumber, String callerinput, String poptype, String calledinto, String calledintime, String tollfreedescription, String callertype, String language, String an1, String upn1, String transferreason, String intent , String brand , boolean validpolicynumber, 
		...
		JSONObject reqBody = null;
			...
			try {
				...
				if(null != CCAI_Agent_Verified && CCAI_Agent_Verified.equalsIgnoreCase("true"))
				{
					agentverified=true;
					
				}
			
				if(null != CCAI_Customer_Verified && CCAI_Customer_Verified.equalsIgnoreCase("true"))
				{
	 ...
	 public static void main(String[] args) {
	  ...
	  String brand = "21C";
	  String TollFreeNumber = "8208928683";
	  String poptype = "01";
	  String CallerType = "02";
	  String ANI = "9028621448";
	  String DestinationApp = "SRM";
	  boolean ValidPolicyNumber = false;
	  String UPN1 = "40223";
	  String AN1 = "162561";
	  String CallerInput = "9049653508";
	  String CalledInto = "9226193551";
	  String CalledInTime = "2023-09-14T10:46:58";
	  String Intent = "pc_policy-add_remove_person";
	  ...
	  FWSsrmcti_NP_Post test = new FWSsrmcti_NP_Post();
