...
public class CheckAniExistByKey {
	...
	private Map<String, String> getHeaders(Logger logger, String callid) {
	 ...
	 /* public static void main(String args[]) {
      ...
      String url = "https://104.156.46.196/IVRAPI/api/AniGroup/CheckAniExistByKey";
	  ...
	  CheckAniExistByKey objCheckAniExistByKey = new CheckAniExistByKey();
	  JSONObject response = objCheckAniExistByKey.start(url, callid, tenantid, key, 10000, 10000, context);
