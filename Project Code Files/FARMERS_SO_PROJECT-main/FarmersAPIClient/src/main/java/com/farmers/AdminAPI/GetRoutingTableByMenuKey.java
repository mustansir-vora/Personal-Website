...
public class GetRoutingTableByMenuKey {
	
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	public JSONObject start(String url, String callid, int tenantid, String key, String dnis, String dnisgroup, String category, String lineofbusiness, int conntimeout, int readtimeout, LoggerContext context) {
		...
		logger.info(callid+" : Params passed = "+url+" ,"+tenantid+", "+key+", "+conntimeout+", "+readtimeout);
	...
	/* public static void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/Routing/GetRoutingTableByMenuKey"; 
	  int tenantid = 2; 
	  String callid = "test123";
	  String key = "KYC FOREMOST"; 
	  String dnis = "99424949010"; 
	  String dnisgroup = "140500"; 
	  String lineofbusiness = "BIL_RETURN-VXF"; 
	  String category = "Farmers Training"; 
	  
	  GetRoutingTableByMenuKey test = new GetRoutingTableByMenuKey();
	  JSONObject response = test.start(url, callid, tenantid, key, dnis, dnisgroup, category, lineofbusiness, 10000, 10000, context);
