...
public class PointGeneralBilling_NP_Get {
...
//private Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	public JSONObject start(String url, String tid, int conntimeout, int readtimeout, LoggerContext context, String region) {
		...
		logger.info(tid+" : Request parameters passed = "+url+", "+tid+", "+conntimeout+", "+readtimeout);
	...
	public JSONObject formatErrorResponse(String error, int statusCode) {
	 ...
	 public static void main(String[] args) {
		 ...
		 String url = "https://api-ss.farmersinsurance.com/billingms/v1/billingaccounts/T07013477402/billingSummary?policyMco=91&policyMod=02&sourceSystem=21C";
		 String tid = "CiscoTest"; 
		 PointGeneralBilling_NP_Get test = new PointGeneralBilling_NP_Get();
		 JSONObject resp = test.start(url, tid, 10000, 10000, context,"uat");
	 } 
