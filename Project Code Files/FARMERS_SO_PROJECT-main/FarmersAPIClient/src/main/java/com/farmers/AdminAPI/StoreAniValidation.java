...
public class StoreAniValidation {
	
	public JSONObject start(String url, String callid, String ani, String ismobile, int conntimeout, int readtimeout, LoggerContext context) {
		Logger logger = context.getLogger(Constants.ADMIN_LOGGER_NAME);
		logger.info(callid+" : Params passed = "+url+" ,"+ani+", "+", "+ismobile+", "+conntimeout+", "+readtimeout);
		JSONObject resp = new JSONObject();
		JSONObject reqbody = new JSONObject();
		reqbody.put("ani", ani);
		reqbody.put("ismobile", ismobile);
  ...
  /*	public static void main(String[] args) {
		  ...
		  String url = "https://104.156.46.196/IVRAPI/api/AniValidation/StoreAniValidation";
		  String callid = "test123";
		  String ani = "8208928683";
		  String ismobile = "true";
		  
		  StoreAniValidation test = new StoreAniValidation();
		  JSONObject response = test.start(url, callid, ani, ismobile, 10000, 10000, context);
	}  */
