...
public class CommercialBizAgent_NP_Get {
	...
	public JSONObject formatErrorResponse(String error, int statusCode) {
	  ...
	  String url ="https://api-ss.farmersinsurance.com/agentms/v2/agents/3619069400?idType=phoneNumber&businessUnit=PLA";
	  String tid = "CiscoTest"; 
	  CommercialBizAgent_NP_Get test = new CommercialBizAgent_NP_Get();
