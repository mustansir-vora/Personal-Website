...
public class MulesoftFarmerPolicyInquiry_NP_Post {
	...
	public JSONObject formatErrorResponse(String error, int statusCode) {
	  ...
	  MulesoftFarmerPolicyInquiry_NP_Post test = new MulesoftFarmerPolicyInquiry_NP_Post();
	  resp = test.start(url, tid, "187343528", null, null, 10000, 10000, context,"uat");
