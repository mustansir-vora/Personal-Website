...
public class GetIvrApiDetails {
	
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	
	public JSONObject start(String url, String callid, int conntimeout, int readtimeout, LoggerContext context) {
		Logger logger = context.getLogger(Constants.ADMIN_LOGGER_NAME);
		logger.info(callid+" : Params passed = "+url+" ,"+conntimeout+", "+readtimeout);
	...
	/*  public static void main(String args[]) {
	  ...
	  String url = "https://104.156.46.196/IVRAPI/api/Ivrapi/GetIvrApiDetails";
	  String callid = "test123";
	  
	  GetIvrApiDetails objGetIvrApiDetails = new GetIvrApiDetails();
	  JSONObject response = objGetIvrApiDetails.start(url, callid, 10000, 10000, context);
