...
public class GetPrequeueMessageRulessByKey {
...
//private static final Logger logger = LogManager.getLogger(Constants.LOGGER_NAME);
	...
	/*  public static void main(String args[]) {
	  ...
	  String url = "https://EC2AMAZ-ALDVADR/fiivrapi/api/PrequeueMessageRules/GetPrequeueMessageRulessByKey";
	  int tenantid = 2; 
	  String key = "21st Service - SPN";
	  String callid = "test123";
	  
	  GetPrequeueMessageRulessByKey test  = new GetPrequeueMessageRulessByKey();
