...
public class AutoPolicy {
	 private AgentDetails agentDetails;
		...
		public String toString() {
			return "AutoPolicy [agentDetails=" + agentDetails + ", basicPolicyDetail=" + basicPolicyDetail
					+ ", basicPolicy=" + basicPolicy + ", insuredVehicle=" + insuredVehicle + ", namedInsured="
					+ namedInsured + ", getAgentDetails()=" + getAgentDetails() + ", getBasicPolicyDetail()="
					+ getBasicPolicyDetail() + ", getBasicPolicy()=" + getBasicPolicy() + ", getInsuredVehicle()="
					+ getInsuredVehicle() + ", getNamedInsured()=" + getNamedInsured() + ", getClass()=" + getClass()
