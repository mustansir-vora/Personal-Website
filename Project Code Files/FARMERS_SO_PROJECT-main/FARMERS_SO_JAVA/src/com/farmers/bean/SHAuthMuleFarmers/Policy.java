...
public class Policy {
	  private String status;
		...
		public String toString() {
			return "Policy [status=" + status + ", producerRoleCode=" + producerRoleCode + ", policySource="
					+ policySource + ", policyNumber=" + policyNumber + ", internalPolicyNumber=" + internalPolicyNumber
					+ ", internalPolicyVersion=" + internalPolicyVersion + ", billingAccountNumber="
					+ billingAccountNumber + ", effectiveDate=" + effectiveDate + ", expirationDate=" + expirationDate
					+ ", renewalEffectiveDate=" + renewalEffectiveDate + ", suffix=" + suffix + ", policyState="
					+ policyState + ", policyStatus=" + policyStatus + ", lineOfBusiness=" + lineOfBusiness
					+ ", serviceLevels=" + serviceLevels + ", insuredDetails=" + insuredDetails + ", producerSubCode="
					+ producerSubCode + ", addresses=" + addresses + ", getStatus()=" + getStatus()
					+ ", getProducerRoleCode()=" + getProducerRoleCode() + ", getPolicySource()=" + getPolicySource()
					+ ", getPolicyNumber()=" + getPolicyNumber() + ", getInternalPolicyNumber()="
					+ getInternalPolicyNumber() + ", getInternalPolicyVersion()=" + getInternalPolicyVersion()
					+ ", getBillingAccountNumber()=" + getBillingAccountNumber() + ", getEffectiveDate()="
					+ getEffectiveDate() + ", getExpirationDate()=" + getExpirationDate()
					+ ", getRenewalEffectiveDate()=" + getRenewalEffectiveDate() + ", getSuffix()=" + getSuffix()
					+ ", getPolicyState()=" + getPolicyState() + ", getPolicyStatus()=" + getPolicyStatus()
					+ ", getLineOfBusiness()=" + getLineOfBusiness() + ", getServiceLevels()=" + getServiceLevels()
					+ ", getInsuredDetails()=" + getInsuredDetails() + ", getProducerSubCode()=" + getProducerSubCode()
					+ ", getAddresses()=" + getAddresses() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
