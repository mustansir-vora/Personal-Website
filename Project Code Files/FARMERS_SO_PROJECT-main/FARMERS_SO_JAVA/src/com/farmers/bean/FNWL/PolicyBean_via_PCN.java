...
public class PolicyBean_via_PCN {
    ...
    private List<String> roles; // Assuming roles is a list of strings
	...
	public String toString() {
		return "PolicyBean_via_PCN [policyType = " + policyType + ", policyCategory = " + policyCategory + ", policyStateCode = " + policyStateCode + ", policySource = " + policySource + ", policyNumber = " + policyNumber + ", policyStatus = " + policyStatus + ", lineOfBusiness = " + lineOfBusiness + ", bookOfBusiness = " + bookOfBusiness + ", issueDate = " + issueDate + ", roles = " + roles + ", dateOfBirth = " + dateOfBirth + ", zip = " + zip + ", addressType = " + addressType + ", addressLine1 = " + addressLine1 +", city = " + city + ", state = " + state + ", country = " + country + ", ssn = " + ssn + ", taxID = " + taxID + ", firsName = " + firstName + ", lastName = " + lastName + "]";
	}
}
