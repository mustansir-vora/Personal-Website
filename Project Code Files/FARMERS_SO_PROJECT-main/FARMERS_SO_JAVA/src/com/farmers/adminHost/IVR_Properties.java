...
/*EM_ADM_0035*/
public class IVR_Properties extends DecisionElementBase {
	...
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException {
		...
		if(data.getSessionData(Constants.S_IVR_PROPERTIES_URL) != null && data.getSessionData(Constants.S_CONN_TIMEOUT) != null && data.getSessionData(Constants.S_READ_TIMEOUT) != null) {
			...
			JSONObject resp =  (JSONObject) test.start(url, callerId, Constants.tenantid, Constants.Roadside_Assistance_Interval, conTimeout, readTimeout, context);
	...
	private String apiResponseManupulation(DecisionElementData data, CommonAPIAccess caa, String currElementName, String strRespBody) {
		...
		try {
			...
			data.setSessionData(Constants.IVR_INTENT_PROPERTY_VALUE, obj.get("propertyvalue"));
