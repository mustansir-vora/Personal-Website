...
public class FASMainMenuStateAreaCode {
	...
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException {
		...
		try {
			objHostDetails.startHostReport(currElementName,"CheckAniExistByKey API", strReqBody, "",(String)data.getSessionData(Constants.S_GET_STATE_BY_AREACODE_URL));
	...
	private String apiResponseManupulation(DecisionElementData data, CommonAPIAccess caa, String currElementName, String strRespBody) {
		...
		try {	
			...
			data.addToLog(currElementName, "S_STATENAME :"+data.getSessionData(Constants.S_STATENAME)+" : S_STATECODE : "
					+data.getSessionData(Constants.S_STATENAME)+" : S_FARMERS_STATECODE : "+data.getSessionData(Constants.S_FARMERS_STATECODE));
