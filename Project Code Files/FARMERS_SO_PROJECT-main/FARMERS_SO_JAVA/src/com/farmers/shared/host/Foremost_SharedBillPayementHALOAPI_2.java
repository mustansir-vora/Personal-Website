...
public class Foremost_SharedBillPayementHALOAPI_2 extends DecisionElementBase {
                ...
                for (Object billingDetailsiterator: billingDetailsarray) {
                    ...
                    if (null != billingdetails && billingdetails.containsKey("policy")) {
                        ...
                        if (null != policydetails && policydetails.containsKey("terms")) {
                            ...
                            if (termdetails.size() == 0) {
                                ...
                                for (int i = 0; i < termdetails.size(); i++) {
                                    ...
                                    if (Status.equalsIgnoreCase("Expired")) {
                                        if(billingstatusCode.equalsIgnoreCase("07"))
                                        StrExitState = "ER";
                                        break;
                                    ...
                                    //code to set Pending Flag for 06/EX
                            ...
                            if ("Y".equalsIgnoreCase(Constants.S_HALO_API_BillingFlag) && billAmountCheck > 0) {
                                data.setSessionData(Constants.S_HALO_API_BillDue, "Y");
                            ...
                            } else if ("Y".equalsIgnoreCase(Constants.S_HALO_API_BillingFlag) && outstandingBalanceCheck > 0) {
                                data.setSessionData(Constants.S_HALO_API_Waiting_TO_Bill, "Y");
