...
public class Foremost_Temp_RouteToCCorPaymentUS extends DecisionElementBase {
	...
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException {
		...
		try {
			String strEntryPoint = (String) data.getSessionData("FM_INVOKED_FROM");
			String FM_Transfer_Route = (String) data.getSessionData("FM_TRANSFER_ROUTE");
		
			if (null != strEntryPoint && strEntryPoint.equalsIgnoreCase("NLU")) {
				
				String appTag = (String) data.getSessionData(Constants.APPTAG);
				
				if (null != appTag && appTag.equalsIgnoreCase("payment-execute")) {
					exitState = "SELFSERVICE";
				}
				else {
				...
				if (null != FM_Transfer_Route && FM_Transfer_Route.equalsIgnoreCase("PAYMENT")) {
					exitState = "SELFSERVICE";
				}
				else {
					caa.createMSPKey(caa, data, "SBP_MN_001", "BILLING QUESTIONS");
			...
			data.addToLog(currElementName,"Exception in Foremost_Temp_RouteToCCorPaymentUS doDecision call  :: "+e);
