...
public class FRMST_PENDING_MN_001 extends DecisionElementBase 
{
	@Override
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException 
	{
		...
		try {
			...
			String returnValue = (String) data.getElementData("FRMST_PENDING_MN_001_Call","Return_Value");
			data.addToLog(currElementName, "Menu ID : "+"FRMST_PENDING_MN_001_Call"+" :: Menu Value : "+returnValue);
			data.setSessionData("FRMST_PENDING_MN_001_Call", returnValue);
			...
			if(returnValue.equalsIgnoreCase(Constants.REPRENSTATIVE)) {
				...
				}else if(returnValue.equalsIgnoreCase(Constants.Make_a_Payment)) {
					createMSPKey(caa, data, "FRMST_PENDING_MN_001", "Make_a_Payment");
	...
	private void createMSPKey(CommonAPIAccess caa, DecisionElementData data, String menuID, String menuValue) {
		try {
			...
			data.addToLog(data.getCurrentElement(),"Exception in FRMST_PENDING_MN_001 :: "+e);
			caa.printStackTrace(e);
		}
	}
