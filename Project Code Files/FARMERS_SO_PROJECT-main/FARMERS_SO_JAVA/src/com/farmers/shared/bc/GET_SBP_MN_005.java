...
public class GET_SBP_MN_005 extends DecisionElementBase 
{
	@Override
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException 
	{
		...
		try {
			...
			String returnValue = (String) data.getElementData("SBP_MN_005_Call","Return_Value");
			data.addToLog(currElementName, "Menu ID : "+"SBP_MN_005"+" :: Menu Value : "+returnValue);
			data.setSessionData("SBP_MN_005_VALUE", returnValue);
			...
			data.addToLog(currElementName,"Exception in SBP_MN_005 :: "+e);
			caa.printStackTrace(e);
		}
		data.addToLog(currElementName,"SBP_MN_005 :: "+strExitState);
		return strExitState;
	...
	private void createMSPKey(CommonAPIAccess caa, DecisionElementData data, String menuID, String menuValue) {
		try {
			...
			if(strFMSTAARP!=null && strCategory!=null && strFMSTAARP.contains(strCategory)) {
				...
				if (data.getSessionData("S_FLAG_FOREMOST_BU").toString().equalsIgnoreCase(Constants.STRING_YES)) {
					strBU = Constants.BU_FOREMOST_CUST;
					strCategoryFlag = "Y";
				} else {
