...
public class Foremost_SBP_MN_001 extends DecisionElementBase 
{
	@Override
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException 
	{
		...
		try {
			...
			String returnValue = (String) data.getElementData("Foremost_SBP_MN_001_Call","Return_Value");
			data.addToLog(currElementName, "Menu ID : "+"Foremost_SBP_MN_001"+" :: Menu Value : "+returnValue);
			data.setSessionData("Foremost_SBP_MN_001_VALUE", returnValue);
			...
			data.addToLog(currElementName,"Exception in Foremost_SBP_MN_001 :: "+e);
			caa.printStackTrace(e);
		}
		data.addToLog(currElementName,"Foremost_SBP_MN_001 :: "+strExitState);
		return strExitState;
