...
public class Foremost_SBP_MN_005 extends DecisionElementBase 
{
	@Override
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException 
	{
		...
		try {
			...
			String returnValue = (String) data.getElementData("FRMST_SBP_MN_005_Call","Return_Value");
			data.addToLog(currElementName, "Menu ID : "+"Foremost_SBP_MN_005"+" :: Menu Value : "+returnValue);
			data.setSessionData("Foremost_SBP_MN_005_VALUE", returnValue);
			...
			data.addToLog(currElementName,"Exception in Foremost_SBP_MN_005 :: "+e);
			caa.printStackTrace(e);
		}
		data.addToLog(currElementName,"Foremost_SBP_MN_005 :: "+strExitState);
		return strExitState;
