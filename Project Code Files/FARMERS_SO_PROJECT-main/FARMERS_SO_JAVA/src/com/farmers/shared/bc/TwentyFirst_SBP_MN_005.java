...
public class TwentyFirst_SBP_MN_005 extends DecisionElementBase 
{
	@Override
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException 
	{
		...
		try {
			...
			String returnValue = (String) data.getElementData("21ST_SBP_MN_005_Call","Return_Value");
			data.addToLog(currElementName, "Menu ID : "+"21ST_SBP_MN_005"+" :: Menu Value : "+returnValue);
			data.setSessionData("FWS_SBP_MN_005_VALUE", returnValue);
			if(returnValue != null && !returnValue.equals("")) {
				...
				if(returnValue.equalsIgnoreCase(Constants.LOOKUP_ANOTHER_POLICY)) {
					...
					createMSPKey(caa, data, "SBP_MN_005", "LIENHOLDER");
			...
			data.addToLog(currElementName,"Exception in FWS_SBP_MN_005 :: "+e);
			caa.printStackTrace(e);
		}
		data.addToLog(currElementName,"FWS_SBP_MN_005 :: "+strExitState);
		return strExitState;
	...
	private void createMSPKey(CommonAPIAccess caa, DecisionElementData data, String menuID, String menuValue) {
		try {
			...
			if(str21stHawaii.contains("Hawaii")) {
				strBU = Constants.BU_21STHAWAII;
				strCategoryFlag = "Y";
			} else  if(strFMSTAARP!=null && strCategory!=null && strFMSTAARP.contains(strCategory)) {
			...
			data.addToLog(data.getCurrentElement(),"Exception in GET_SBP_MN_005 :: "+e);
			caa.printStackTrace(e);
		}
	}
