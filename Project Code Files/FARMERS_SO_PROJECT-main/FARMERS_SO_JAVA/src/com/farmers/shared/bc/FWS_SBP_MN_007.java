...
public class FWS_SBP_MN_007 extends DecisionElementBase 
{
	@Override
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException 
	{
		...
		try {
			...
			if (currElementName.equalsIgnoreCase("21ST_SBP_MN_007_VALUE")) {
				strReturnValue = (String) data.getElementData("21ST_SBP_MN_007_Call","Return_Value");
				data.addToLog(currElementName, "Menu ID : "+"FWS_SBP_MN_007"+" :: Menu Value : "+strReturnValue);
				data.setSessionData("21ST_SBP_MN_007_VALUE", strReturnValue);
			}
			else {
				strReturnValue = (String) data.getElementData("FWS_SBP_MN_007_Call","Return_Value");
				data.addToLog(currElementName, "Menu ID : "+"FWS_SBP_MN_007"+" :: Menu Value : "+strReturnValue);
				data.setSessionData("FWS_SBP_MN_007_VALUE", strReturnValue);
			}
