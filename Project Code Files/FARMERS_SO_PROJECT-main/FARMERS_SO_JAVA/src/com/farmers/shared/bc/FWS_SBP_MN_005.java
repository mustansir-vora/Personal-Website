...
public class FWS_SBP_MN_005 extends DecisionElementBase 
{
	@Override
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException 
	{
		...
		try {
			...
			String returnValue = (String) data.getElementData("FWS_SBP_MN_005_Call","Return_Value");
			data.addToLog(currElementName, "Menu ID : "+"FWS_SBP_MN_005"+" :: Menu Value : "+returnValue);
