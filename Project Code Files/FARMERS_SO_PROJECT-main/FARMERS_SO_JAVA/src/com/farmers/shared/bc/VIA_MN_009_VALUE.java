...
public class VIA_MN_009_VALUE extends DecisionElementBase {
	...
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException 
	{
		...
		try {
			...
			String returnValue = (String) data.getElementData("VIA_MN_009_Call","Return_Value");
			data.addToLog(currElementName, "Menu ID : "+"VIA_MN_009"+" :: Menu Value : "+returnValue);
			data.setSessionData("VIA_MN_009_VALUE", returnValue);
			...
			if (Constants.NOINPUT.equalsIgnoreCase(returnValue)) {
				...
				strExitState = Constants.SOMETHINGELSE;
			}else if(returnValue.equalsIgnoreCase("All of these")) {
				strExitState = Constants.AllofThese;
			}else if(returnValue.equalsIgnoreCase(Constants.REPRESENTATIVE)) {
				data.setSessionData("LAST_MENU_NAME_REP", "VIA_MN_009");
			...
			}else if (Constants.Continue.equalsIgnoreCase(returnValue)) {
			    strExitState = Constants.Continue;
			    }
		} catch (Exception e) {
			data.addToLog(currElementName,"Exception in VIA_MN_009 :: "+e);
			caa.printStackTrace(e);
		}
		data.addToLog(currElementName,"VIA_MN_009 :: "+strExitState);
		return strExitState;
