...
public class GET_SBP_MN_001 extends DecisionElementBase 
{
	@Override
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException 
	{
		...
		try {
			...
			String returnValue = (String) data.getElementData("SBP_MN_001_Call","Return_Value");
			data.addToLog(currElementName, "Menu ID : "+"SBP_MN_001"+" :: Menu Value : "+returnValue);
			data.setSessionData("SBP_MN_001_VALUE", returnValue);
			if(returnValue != null && !returnValue.equals("")) {
				strExitState = returnValue;

				//EXIT STATE FROM GDF IS EQUALS TO DECISION EXIT STATE
