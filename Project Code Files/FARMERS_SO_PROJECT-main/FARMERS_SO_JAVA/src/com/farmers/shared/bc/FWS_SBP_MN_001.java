...
public class FWS_SBP_MN_001 extends DecisionElementBase 
{
	@Override
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException 
	{
		...
		try {
			...
			String returnValue = (String) data.getElementData("FWS_SBP_MN_001_Call","Return_Value");
			data.addToLog(currElementName, "Menu ID : "+"FWS_SBP_MN_001"+" :: Menu Value : "+returnValue);
			data.setSessionData("FWS_SBP_MN_001_VALUE", returnValue);
