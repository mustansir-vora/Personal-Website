...
public class GET_SBP_MN_003 extends DecisionElementBase 
{
	@Override
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException 
	{
		...
		try {
			...
			String strReturnValue = (String) data.getElementData("SBP_MN_003_Call","Return_Value");
			data.addToLog(currElementName, "Menu ID : "+"SBP_MN_003"+" :: Menu Value : "+strReturnValue);
			data.setSessionData("SBP_MN_003_VALUE", strReturnValue);
