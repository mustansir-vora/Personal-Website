...
public class FSEL_MN_001_VALUE extends DecisionElementBase {
	...
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException {
		...
		try {
			String strReturnValue = (String) data.getElementData("FSEL_MN_001_Call","Return_Value");
			data.setSessionData(Constants.FSEL_MN_001_VALUE, strReturnValue);
			...
			data.addToLog(currElementName,"Exception in FSEL_MN_001_VALUE :: "+e);
			caa.printStackTrace(e);
		}
		data.addToLog(currElementName,"FSEL_MN_001_VALUE :: "+strExitState);
		/*
