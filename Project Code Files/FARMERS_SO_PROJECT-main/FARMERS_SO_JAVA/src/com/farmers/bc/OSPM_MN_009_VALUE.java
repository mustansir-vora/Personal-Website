...
public class OSPM_MN_009_VALUE extends DecisionElementBase {
	...
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException {
		...
		try {
			String strReturnValue = (String) data.getElementData("OSPM_MN_009_Call", "Return_Value");
			data.addToLog(currElementName, "OSPM_MN_009_Call : Return_Value :: " + strReturnValue);
			data.setSessionData("OSPM_MN_009_VALUE", strReturnValue);
			String regex = "(.)*(\\d)(.)*";
			...
			if (matcher.matches()) {
				...
				data.addToLog(currElementName,
						"OSPM_MN_009 policy number :: " + (String) data.getSessionData(Constants.S_POLICY_NUM));
			...
			data.addToLog(currElementName, "Exception in OSPM_MN_009_VALUE :: " + e);
			caa.printStackTrace(e);
		}
		data.addToLog(currElementName, "OSPM_MN_009_VALUE :: " + strExitState);
		return strExitState;
	}
}