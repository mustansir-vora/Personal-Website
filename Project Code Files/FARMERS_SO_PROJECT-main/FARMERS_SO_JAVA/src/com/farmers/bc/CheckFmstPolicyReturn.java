...
public class CheckFmstPolicyReturn extends DecisionElementBase {
	...
	public String doDecision(String elementName, DecisionElementData data) throws AudiumException {
		...
		try {
			String strPolicyFound = (String) data.getElementData("FmstCollectPolicyOnly", "POLICY_FOUND");
			/*
			...
			data.addToLog(elementName, " FmstCollectPolicyOnly :: Return Value " + strPolicyFound);
