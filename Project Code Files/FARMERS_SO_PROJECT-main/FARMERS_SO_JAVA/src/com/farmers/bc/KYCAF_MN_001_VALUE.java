...
public class KYCAF_MN_001_VALUE extends DecisionElementBase {
	...
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException {
		...
		try {
			String strReturnValue = (String) data.getElementData("KYCAF_MN_001_Call","Return_Value");
			data.addToLog(currElementName, " KYCAF_MN_001_Call : Return_Value :: "+strReturnValue);
			data.setSessionData(Constants.S_PRODUCER_CODE, strReturnValue);
			data.setSessionData(Constants.KYCAF_MN_001_VALUE, strReturnValue);
			String regex = "(.)*(\\d)(.)*";      
			...
			data.addToLog(currElementName,"Exception in KYCAF_MN_001_VALUE :: "+e);
