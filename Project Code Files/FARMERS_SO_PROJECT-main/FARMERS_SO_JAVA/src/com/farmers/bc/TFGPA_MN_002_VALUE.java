...
public class TFGPA_MN_002_VALUE extends DecisionElementBase {
	...
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException {
		...
		try {
			String strReturnValue = (String) data.getElementData("TFGPA_MN_002_Call", "Return_Value");
			data.addToLog(currElementName, " TFGPA_MN_002_VALUE : Return_Value :: " + strReturnValue);
			data.setSessionData("TFGPA_MN_002_VALUE", strReturnValue);
			...
			if (matcher.matches()) {
				...
				data.setSessionData("S_AMOUNT_VALIDATION_INVOKED_FROM", "TFGPA_MN_002");
				...
				data.addToLog(currElementName, "Amount to be sent setted in Full Balance :: " + data.getSessionData("S_AMOUNT_TOBE_SENT"));
				strExitState = "full balance";
			} else if (strReturnValue.equalsIgnoreCase("minimum due")) {
				data.setSessionData("S_AMOUNT_TOBE_SENT", data.getSessionData("S_Current_Balance"));
				data.setSessionData(Constants.VXMLParam1, (String) data.getSessionData("S_AMOUNT_TOBE_SENT"));
			...
			data.addToLog(currElementName, "Exception in TFGPA_MN_002_VALUE :: " + e);
			caa.printStackTrace(e);
		}

		data.addToLog(currElementName, "TFGPA_MN_002_VALUE :: " + strExitState);
		return strExitState;
	}
}