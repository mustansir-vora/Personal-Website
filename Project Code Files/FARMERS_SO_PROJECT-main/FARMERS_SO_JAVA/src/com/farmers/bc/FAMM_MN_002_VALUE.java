...
public class FAMM_MN_002_VALUE extends DecisionElementBase {
	...
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException {
		...
		try {
			...
			String strReturnValue = (String) data.getElementData("FAMM_MN_002_Call", "Return_Value");
			data.addToLog(currElementName, " FAMM_MN_002_VALUE : Return_Value :: " + strReturnValue);
			data.setSessionData("FAMM_MN_002_VALUE", strReturnValue);
			...
			data.addToLog(currElementName, "Exception in FAMM_MN_002_VALUE :: " + e);
