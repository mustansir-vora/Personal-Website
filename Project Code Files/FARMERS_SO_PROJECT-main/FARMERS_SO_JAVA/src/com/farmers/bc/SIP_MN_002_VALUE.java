...
public class SIP_MN_002_VALUE extends DecisionElementBase {
	...
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException {
		...
		try {
			String strReturnValue = (String) data.getElementData("SIP_MN_002_Call","Return_Value");
			data.addToLog(currElementName, " SIP_MN_002_Call : Return_Value :: "+strReturnValue);
			data.setSessionData(Constants.SIP_MN_002_VALUE, strReturnValue);
			...
			data.addToLog(currElementName,"Exception in SIP_MN_002_VALUE :: "+e);
			caa.printStackTrace(e);
		}
		data.addToLog(currElementName,"SIP_MN_002_VALUE :: "+strExitState);
		/*
