...
public class SD_MN_001_VALUE extends DecisionElementBase {
	...
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException {
		...
		try {
			String strReturnValue = (String) data.getElementData("SD_MN_001_Call","Return_Value");
			data.addToLog(currElementName, " SD_MN_001_Call : Return_Value :: "+strReturnValue);
			data.setSessionData(Constants.SD_MN_001_VALUE, strReturnValue);
			...
			data.addToLog(currElementName,"Exception in SD_MN_001_VALUE :: "+e);
			caa.printStackTrace(e);
		}
		data.addToLog(currElementName,"SD_MN_001_VALUE :: "+strExitState);
		/*
