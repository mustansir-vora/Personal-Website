...
public class FMAA_MN_004_VALUE extends DecisionElementBase {
	...
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException {
		...
		try {
				...
				String strReturnValue = (String) data.getElementData("FMAA_MN_004_Call", "Return_Value");
				data.addToLog(currElementName, "FMAA_MN_004_Call : Return_Value :: " + strReturnValue);
				...
				if (null != strReturnValue) {
					if (strReturnValue.equalsIgnoreCase(Constants.NOINPUT)) {
						...
						caa.createMSPKey(caa, data, "FMAA_MN_004", "MOBILE HOME");
						...
						caa.createMSPKey(caa, data, "FMAA_MN_004", "SPECIALTY DWELLING");
						...
						caa.createMSPKey(caa, data, "FMAA_MN_004", "MOTOR CYCLE");
						...
						caa.createMSPKey(caa, data, "FMAA_MN_004", "MOTOR HOME");
						...
						caa.createMSPKey(caa, data, "FMAA_MN_004", "OFF ROAD VEHICLE");
						...
						caa.createMSPKey(caa, data, "FMAA_MN_004", "REPRESENTATIVE");
					} else {
					...
					strExitState = Constants.ER;
					data.addToLog(currElementName, "FMAA_MN_004 if the value from GDF is null :: " + strReturnValue);
				}

				data.setSessionData("S_FMAA_MN_004_RETURN_VALUE", strExitStateTemp);
				data.addToLog(currElementName, "S_FMAA_MN_004_RETURN_VALUE :: " + strExitStateTemp);
		} catch (

				Exception e) {
			data.addToLog(currElementName, "Exception in FMAA_MN_004_VALUE :: " + e);
			caa.printStackTrace(e);
		}
		data.addToLog(currElementName, "FMAA_MN_004_VALUE :: " + strExitState);

		//		String menuExsitState = strExitState;
		//		if (strExitState.contains(" "))
		//			menuExsitState = menuExsitState.replaceAll(" ", "_");
		//		if (null != (String) data.getSessionData("FMAA_MN_004_" + menuExsitState)
		//				&& !((String) data.getSessionData("FMAA_MN_004_" + menuExsitState)).isEmpty())
		//			menuExsitState = (String) data.getSessionData("FMAA_MN_004_" + menuExsitState);
		//		data.addToLog(currElementName, "Final Value of Menu Exit State for FMAA_MN_004: " + menuExsitState);
		//		data.setSessionData(Constants.S_MENU_SELECTION_KEY,
		//				data.getSessionData(Constants.S_BU) + ":FMAA_MN_004:" + menuExsitState);
		//		data.addToLog(currElementName,
		//				"S_MENU_SELECTION_KEY FMAA_MN_004: " + (String) data.getSessionData("S_MENU_SELCTION_KEY"));
		return strExitState;
	}
}