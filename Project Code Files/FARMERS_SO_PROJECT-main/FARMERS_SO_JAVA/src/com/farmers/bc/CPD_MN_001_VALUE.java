...
public class CPD_MN_001_VALUE extends DecisionElementBase {
	...
	public String doDecision(String currElementName, DecisionElementData data) throws AudiumException {
		...
		try {
			String strReturnValue = (String) data.getElementData("CPD_MN_001_Call","Return_Value");
			data.addToLog(currElementName, "CPD_MN_001_Call : Return_Value :: "+strReturnValue);
			data.setSessionData(Constants.CPD_MN_001_VALUE, strReturnValue);
			...
			data.addToLog(currElementName,"Exception in CPD_MN_001_VALUE :: "+e);
			caa.printStackTrace(e);
		}
		data.addToLog(currElementName,"CPD_MN_001_VALUE :: "+strExitState);
		/*
