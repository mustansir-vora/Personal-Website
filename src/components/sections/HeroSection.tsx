...
export default function HeroSection() {
  return (
    <section id="home" className="min-h-screen flex flex-col items-center justify-center relative px-6 pt-32 pb-32 md:p-0 md:pt-40 md:pb-12 overflow-hidden w-full max-w-[100vw]">
      ...
      <div className="max-w-7xl mx-auto w-full px-6 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8 mt-4 md:mt-20">
        ...
        {/* Right Column - 3D Glassmorphic Sphere */}
        <motion.div 
        ...
        >
          ...
          <motion.div 
            ...
            className="absolute inset-0 rounded-full border border-emerald-500/20 shadow-[0_0_80px_rgba(16,185,129,0.1)] border-t-emerald-400/60 transform-gpu will-change-transform"
            style={{ margin: '10%' }}
          />
          {/* Inner sphere base */}
          <div className="relative w-[70%] h-[70%] rounded-full overflow-hidden shadow-2xl glass border border-white/20">
            {/* 3D highlights and shadows */}
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-white/30 to-transparent" />
            <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-teal-900/40 via-transparent to-white/10" />
            ...
            <motion.div 
              ...
              className="absolute top-1/4 left-1/4 w-1/2 h-1/2 rounded-full bg-lime-400/40 blur-2xl transform-gpu will-change-transform"
            />
            <motion.div 
              animate={{ 
                x: [0, -30, 20, 0], 
              ...
              className="absolute bottom-1/4 right-1/4 w-1/2 h-1/2 rounded-full bg-emerald-500/40 blur-2xl transform-gpu will-change-transform"
            />
            
            {/* Glass reflection */}
            <div className="absolute top-4 left-6 w-1/3 h-1/4 rounded-full bg-gradient-to-b from-white/40 to-transparent rotate-[-30deg] blur-[2px]" />
          </div>
        </motion.div>
      </div>
