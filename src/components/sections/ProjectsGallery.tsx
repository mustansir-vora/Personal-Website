            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {projects.map((project) => (
                <motion.div
                  ...
                  className="glass p-6 md:p-8 rounded-3xl cursor-pointer hover:bg-white/10 transition-colors border border-white/10 hover:border-emerald-500/50 group flex flex-col h-full"
                >
                  <motion.h3 layoutId={`title-${project.id}`} className="text-xl md:text-2xl font-bold text-white mb-2 group-hover:text-lime-300 transition-colors">
                    {project.title}
                  </motion.h3>
                  <motion.p layoutId={`client-${project.id}`} className="text-lime-300 font-medium mb-4 text-sm">
                    {project.client}
                  </motion.p>

                  <motion.div layoutId={`tags-${project.id}`} className="flex flex-wrap gap-2 mb-5">
                  ...
                  <motion.p layoutId={`desc-${project.id}`} className="text-muted-foreground text-sm flex-grow">
                    {project.shortDesc}
                  </motion.p>
                ...
                >
                  ...
                  <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                    ...
                    <motion.div
                      ...
                      className="space-y-4"
                    >
                      <h4 className="text-xl font-bold text-white">Key Contributions:</h4>
                      ...
                      {selectedProject.githubUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="mt-6 inline-flex items-center gap-3 px-6 py-3 glass rounded-xl text-white font-medium hover:bg-white/15 transition-colors border border-white/10 hover:border-emerald-500/50"
                        >
